    ...
    <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 shadow-2xl">
      <form onSubmit={handleSignup} className="space-y-5">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full py-3 px-4 bg-white text-black rounded-lg font-medium hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-zinc-900 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
        >
          {loading ? (
